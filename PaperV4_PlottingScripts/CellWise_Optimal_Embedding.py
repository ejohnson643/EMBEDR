...
if __name__ == "__main__":
    ...
    if True:
        ...
        try:
            ...
            data_EES = opt_pVal_dict['data_EES']
            null_EES = opt_pVal_dict['null_EES']
            pVals    = opt_pVal_dict['pVals']
    ...
    if True:
        ...
        ax.set_title(r"No Labels", pad=sctr_title_pad)
    ...
    if True:
        ...
        sort_idx = np.argsort(pVals.squeeze())[::-1]

        clrs = -np.log10(pVals.squeeze()[sort_idx])
